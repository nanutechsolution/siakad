...
<head>
    ...
    <!-- =========================================================
         TITLE
    ========================================================== -->
    <title>SIAKAD UNMARIS - Universitas Stella Maris Sumba</title>
    ...
    <meta property="og:image:alt" content="Logo Universitas Stella Maris Sumba">
    ...
    <meta name="twitter:image:alt" content="Logo Universitas Stella Maris Sumba">
...
<body
    class="bg-slate-50 text-slate-900 antialiased h-[100dvh] w-full flex flex-col relative selection:bg-yellow-500 selection:text-indigo-950">
    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div
            class="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] bg-indigo-900/5 rounded-full blur-3xl">
        </div>

        <div
            class="absolute -bottom-[20%] -left-[10%] w-[50%] h-[50%] bg-yellow-500/5 rounded-full blur-3xl">
        </div>
    </div>
    ...
    <header class="w-full px-6 py-4 flex justify-between items-center z-10 shrink-0">
        ...
        <!-- System Status -->
        <div
            class="flex items-center gap-2 bg-white px-3 py-1.5 rounded-full border border-slate-200 shadow-sm">
    ...
    <main
        ...
        <div class="text-center mb-8 sm:mb-10 animate-logo-pop">
            ...
            <div
                class="inline-flex justify-center items-center bg-white p-4 rounded-3xl shadow-sm border border-slate-100 mb-6">

                <img
                    src="{{ asset('images/logo-unmaris.png') }}"
                    alt="Logo UNMARIS"
        ...
        <div
            ...
            <a
                href="/mahasiswa"
                class="card-1 group relative bg-white p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-yellow-400 transition-all duration-200 flex flex-row md:flex-col items-center md:text-center gap-4 sm:gap-5 focus:outline-none focus:ring-4 focus:ring-yellow-400/20 active:scale-[0.98]">

                <div
                    class="h-12 w-12 sm:h-16 sm:w-16 shrink-0 bg-yellow-50 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl group-hover:scale-110 transition-transform duration-300">
                    🎓
                </div>

                <div class="flex-1 md:w-full text-left md:text-center">
                    <h2
                        class="text-lg sm:text-xl font-bold text-indigo-950 mb-0.5 sm:mb-1">
                        Mahasiswa
                    </h2>

                    <p
                        class="text-xs sm:text-sm text-slate-500 hidden sm:block">
                        KRS, Jadwal, Nilai & Transkrip
                    </p>
                </div>

                <div
                    class="md:hidden text-slate-300 group-hover:text-yellow-500 transition-colors">
            ...
            <a
                href="/dosen"
                class="card-2 group relative bg-white p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-indigo-400 transition-all duration-200 flex flex-row md:flex-col items-center md:text-center gap-4 sm:gap-5 focus:outline-none focus:ring-4 focus:ring-indigo-400/20 active:scale-[0.98]">

                <div
                    class="h-12 w-12 sm:h-16 sm:w-16 shrink-0 bg-indigo-50 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl group-hover:scale-110 transition-transform duration-300">
                    👨‍🏫
                </div>
                ...
                <div class="flex-1 md:w-full text-left md:text-center">
                    ...
                    <p
                        class="text-xs sm:text-sm text-slate-500 hidden sm:block">
                        Presensi, Penilaian & Bimbingan
                    </p>

                </div>

                <div
                    class="md:hidden text-slate-300 group-hover:text-indigo-500 transition-colors">
            ...
            <a
                href="/admin"
                class="card-3 group relative bg-white p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-slate-400 transition-all duration-200 flex flex-row md:flex-col items-center md:text-center gap-4 sm:gap-5 focus:outline-none focus:ring-4 focus:ring-slate-400/20 active:scale-[0.98]">

                <div
                    class="h-12 w-12 sm:h-16 sm:w-16 shrink-0 bg-slate-100 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl group-hover:scale-110 transition-transform duration-300">
                    ⚙️
                </div>
                ...
                <div class="flex-1 md:w-full text-left md:text-center">
                    ...
                    <p
                        class="text-xs sm:text-sm text-slate-500 hidden sm:block">
                        Manajemen Master Data & Sistem
                    </p>

                </div>

                <div
                    class="md:hidden text-slate-300 group-hover:text-slate-500 transition-colors">
    ...
    ========================================================== -->
    <footer
        class="w-full p-4 sm:p-6 shrink-0 flex flex-col items-center justify-center gap-2 text-center z-10">

        <div class="flex flex-wrap items-center justify-center gap-2">

            <button
                type="button"
                class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 transition-colors flex items-center gap-1.5 bg-indigo-50 px-4 py-2 rounded-lg">
            ...
            <a
                href="{{ route('panduan.krs') }}"
                class="text-sm font-semibold text-yellow-700 hover:text-yellow-800 transition-colors flex items-center gap-1.5 bg-yellow-50 px-4 py-2 rounded-lg">
