    ...
    <div class="mx-auto max-w-3xl">
        <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-950 dark:text-white">
                            {{ str_contains($eligibilityMessage, 'Penawaran mata kuliah belum lengkap')
            ...
            <div class="space-y-5 p-6">
                ...
                @if(str_contains($eligibilityMessage, 'Penawaran mata kuliah belum lengkap'))
                ...
                <div>
                    ...
                    <div class="divide-y divide-gray-200 overflow-hidden rounded-xl border border-gray-200 dark:divide-white/10 dark:border-white/10">
                        ...
                        $daftarMk = str_contains($message, ': ')
                        ? explode(': ', $message, 2)[1]
                        : null;

                        $daftarMk = $daftarMk
                        ? preg_replace('/\. KRS belum dapat diajukan.*$/', '', $daftarMk)
                        : null;

                        $mataKuliah = $daftarMk
                        ? array_filter(array_map('trim', explode(', ', $daftarMk)))
                        : [];
                        @endphp
