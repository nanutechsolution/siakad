    ...
    <div class="relative z-10 p-5 sm:p-7 md:p-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
            ...
            <div class="p-4 bg-white/10 hover:bg-white/15 transition-colors rounded-2xl border border-white/10">
                ...
                <div class="text-xl sm:text-3xl font-black">{{ number_format($ips, 2) }}</div>
            </div>
            
            <!-- Box 3 -->
            <div class="p-4 bg-white/10 hover:bg-white/15 transition-colors rounded-2xl border border-white/10">
                <div class="text-[10px] sm:text-xs font-bold text-primary-200 uppercase tracking-widest mb-1">Batas Maksimal</div>
