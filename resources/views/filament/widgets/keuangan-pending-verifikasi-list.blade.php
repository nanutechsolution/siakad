            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200 text-left text-xs uppercase tracking-wide text-gray-500 dark:border-white/10 dark:text-gray-400">
                        ...
                        <th class="py-2 pr-4 font-medium">Metode</th>
                        <th class="py-2 pr-4 font-medium">Tanggal Bayar</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr>
                        ...
                        <td class="py-2 pr-4 text-gray-600 dark:text-gray-400">Rp {{ number_format((float) $row->nominal_bayar, 0, ',', '.') }}</td>
                        <td class="py-2 pr-4 text-gray-600 dark:text-gray-400">{{ $row->metode_pembayaran }}</td>
                        <td class="py-2 pr-4 text-gray-600 dark:text-gray-400">
                            {{ \Illuminate\Support\Carbon::parse($row->tanggal_bayar)->translatedFormat('d M Y, H:i') }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
