...
final class ExcelMigrationSource implements MigrationSourceInterface
{
    ...
    public function validate(): array
    {
        ...
        if (! in_array($extension, ['xlsx', 'xls'], true)) {
            $errors[] = 'File harus berformat .xlsx atau .xls.';
        }
    ...
    {
        return $this->cachedRawRows ??= $this->readRows($this->filePath, 'Xlsx');
    }
}