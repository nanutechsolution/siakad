...
CREATE TABLE `akademik_ekuivalensi` (
  ...
  `minimal_nilai_asal` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'C' COMMENT 'Grade minimal dari MK Asal untuk syarat penyetaraan',
  `sks_diakui` int DEFAULT NULL COMMENT 'Jumlah SKS yang akan diakui di transkrip baru',
  `group_identifier` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ID grup jika beberapa MK Asal digabung menjadi satu MK Tujuan',
...
CREATE TABLE `akademik_transkrip` (
  ...
  `nilai_huruf_final` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `dispensasi_akademik_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `dispensasi_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `aksi` enum('DIBUAT','DIUPDATE','DISETUJUI','DITOLAK','DIBATALKAN','EXPIRED') COLLATE utf8mb4_unicode_ci NOT NULL,
  `dilakukan_oleh` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `dispensasi_akademiks` (
  ...
  `mahasiswa_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis` enum('KRS') COLLATE utf8mb4_unicode_ci NOT NULL,
  `alasan` text COLLATE utf8mb4_unicode_ci,
  `berlaku_mulai` date NOT NULL,
  `berlaku_sampai` date NOT NULL,
  `status` enum('DRAFT','AKTIF','EXPIRED','DIBATALKAN') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DRAFT',
...
CREATE TABLE `generator_logs` (
  ...
  `mahasiswa_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('BERHASIL','GAGAL','DILEWATI') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `jadwal_ujian_pengawas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `jadwal_ujian_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `person_id` bigint unsigned NOT NULL,
  `peran` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENGAWAS',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `jadwal_ujian_pesertas` (
  ...
  `nomor_kursi` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `waktu_check_in` datetime DEFAULT NULL,
  `catatan_pelanggaran` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `jadwal_ujians` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jadwal_kuliah_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis_ujian` enum('UTS','UAS','SUSULAN','LAINNYA') COLLATE utf8mb4_unicode_ci NOT NULL,
  `tanggal_ujian` date NOT NULL,
  `jam_mulai` time NOT NULL,
  `jam_selesai` time NOT NULL,
  `ruang_id` bigint unsigned DEFAULT NULL,
  `metode_ujian` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TERTULIS',
  `keterangan` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `keuangan_adjustments` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nomor_adjustment` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `diajukan_oleh` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `dibatalkan_oleh` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dibatalkan_at` timestamp NULL DEFAULT NULL,
  `alasan_pembatalan` text COLLATE utf8mb4_unicode_ci,
  `adjustment_pembalik_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tindak_lanjut_kelebihan_bayar` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TIDAK_ADA',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `keuangan_beasiswa_details` (
  ...
  `tipe_diskon` enum('PERSENTASE','NOMINAL') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `keuangan_detail_tarif` (
  ...
  `penerapan` enum('FLAT','ONCE') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'FLAT' COMMENT 'FLAT: Tiap Semester, ONCE: Sekali Saja',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `keuangan_general_ledgers` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mahasiswa_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `referensi_dokumen` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipe_transaksi` enum('TAGIHAN','PEMBAYARAN','ADJUSTMENT','REFUND') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `keuangan_komponen_biaya` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode_komponen` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `keuangan_master_beasiswas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_beasiswa` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kategori` enum('INTERNAL','EKSTERNAL','PEMERINTAH') COLLATE utf8mb4_unicode_ci NOT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `krs` (
  ...
  `disetujui_oleh` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `disetujui_pada` timestamp NULL DEFAULT NULL,
  `ditolak_oleh` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ditolak_pada` timestamp NULL DEFAULT NULL,
  `catatan_admin` text COLLATE utf8mb4_unicode_ci,
  `is_financial_verified` tinyint(1) NOT NULL DEFAULT '0',
  `financial_override_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `financial_override_reason` text COLLATE utf8mb4_unicode_ci,
  `total_sks_diambil` int NOT NULL DEFAULT '0',
  `dispensasi_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `krs_status_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `krs_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `aksi` enum('DIAJUKAN','DISETUJUI','DITOLAK','DIBATALKAN','DIBUKA_KEMBALI','DIUBAH_ADMIN') COLLATE utf8mb4_unicode_ci NOT NULL,
  `dilakukan_oleh` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `before_data` json DEFAULT NULL,
  `after_data` json DEFAULT NULL,
  `catatan` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `kurikulum_mk_prasyarat` (
  ...
  `min_nilai_huruf` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'D',
  `prasyarat_kurikulum_mk_id` bigint unsigned NOT NULL,
  `min_nilai` decimal(3,2) NOT NULL DEFAULT '2.00',
  `logic_type` enum('AND','OR') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'AND',
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_akreditasi_elemens` (
  ...
  `status_kelengkapan` enum('BELUM','PROSES','LENGKAP') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'BELUM',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_akreditasi_kriterias` (
  ...
  `kode_kriteria` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lpm_akreditasi_lembagas` (
  ...
  `jenis` enum('INSTITUSI','PRODI') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PRODI',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_akreditasis` (
  ...
  `jenis_akreditasi` enum('INSTITUSI','PRODI') COLLATE utf8mb4_unicode_ci NOT NULL,
  `instrumen` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'mis. IAPS 4.0, IAPT 3.0',
  `status` enum('PERSIAPAN','PENGISIAN','SUBMIT','VISITASI','SELESAI') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PERSIAPAN',
  `peringkat_target` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `peringkat_hasil` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `lpm_ami_checklist_jawabans` (
  ...
  `jawaban` enum('SESUAI','TIDAK_SESUAI','OBSERVASI') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `catatan` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `lpm_ami_findings` (
  ...
  `prodi_id` bigint unsigned NOT NULL,
  `jenis_temuan` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OBSERVASI' COMMENT 'MAYOR, MINOR, OBSERVASI',
  `standar_id` bigint unsigned NOT NULL,
  ...
  `status_workflow` enum('OPEN','ACTION_PLAN','VERIFICATION','CLOSED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OPEN',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_ami_program_auditors` (
  ...
  `peran` enum('KETUA_TIM','ANGGOTA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ANGGOTA',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_ami_programs` (
  ...
  `status` enum('DIJADWALKAN','BERLANGSUNG','SELESAI') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DIJADWALKAN',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_auditors` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `person_id` bigint unsigned NOT NULL,
  `no_sertifikat_auditor` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `lpm_dokumen_approvals` (
  ...
  `person_id` bigint unsigned NOT NULL,
  `peran` enum('PENYUSUN','PEMERIKSA','PENGESAH') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('PENDING','APPROVED','REJECTED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  `catatan` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `lpm_dokumen_riwayats` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `dokumen_id` bigint unsigned NOT NULL,
  `versi_lama` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `versi_baru` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lpm_edom_jawaban` (
  ...
  `jawaban_nilai` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bisa skor angka atau isian teks/esai',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lpm_iku_targets` (
  ...
  `file_bukti_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('DRAFT','SUBMITTED','VALIDATED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DRAFT',
...
CREATE TABLE `lpm_indikators` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `standar_id` bigint unsigned NOT NULL,
  `kode_indikator` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama_indikator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `satuan` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '%, Orang, Dokumen, dll',
  `deskripsi` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `lpm_kuisioner_pertanyaan` (
  ...
  `jenis_input` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RATING_4' COMMENT 'RATING_4, RATING_5, ESSAY, BOOLEAN',
...
CREATE TABLE `lpm_survey_jawaban_pihak` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `jenis_responden` enum('DOSEN','TENDIK','ALUMNI','PENGGUNA_LULUSAN') COLLATE utf8mb4_unicode_ci NOT NULL,
  `person_id` bigint unsigned DEFAULT NULL,
  `nama_eksternal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instansi_eksternal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pertanyaan_id` bigint unsigned NOT NULL,
  `tahun_akademik_id` bigint unsigned NOT NULL,
  `jawaban_nilai` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `lpm_unit_kerjas` (
  ...
  `jenis_unit` enum('UNIVERSITAS','FAKULTAS','PRODI','LEMBAGA','BIRO','UPT') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lpm_unit_pics` (
  ...
  `unit_kerja_id` bigint unsigned NOT NULL,
  `person_id` bigint unsigned NOT NULL,
  `peran` enum('KETUA','SEKRETARIS','GKM','AUDITOR','ANGGOTA') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lppm_luarans` (
  ...
  `judul_luaran` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_penerbit_jurnal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tautan_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tahun_terbit` year NOT NULL,
  `status_verifikasi` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE `lppm_ref_jenis_luarans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode_luaran` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_luaran` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lppm_ref_jenis_skemas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode_jenis` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_jenis` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lppm_usulan_anggotas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `usulan_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `person_id` bigint unsigned NOT NULL,
  `peran_anggota` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ANGGOTA',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lppm_usulans` (
  ...
  `dosen_ketua_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul_usulan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `file_proposal_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_usulan` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DRAFT',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `master_kurikulums` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `no_sk_kurikulum` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tgl_sk_kurikulum` date DEFAULT NULL,
  `id_kurikulum_feeder` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `migration_batches` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `source` enum('EXCEL','CSV','NEO_DATABASE','NEO_API') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('PROCESSING','COMPLETED','FAILED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PROCESSING',
  `file_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pmb_camaba_staging` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `external_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nomor pendaftaran dari PMB',
  ...
  `error_log` text COLLATE utf8mb4_unicode_ci COMMENT 'Pesan error jika gagal diproses',
  `retry_count` tinyint unsigned NOT NULL DEFAULT '0',
  `last_retry_at` timestamp NULL DEFAULT NULL,
  `processed_at` timestamp NULL DEFAULT NULL,
  `source` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PMB',
  `ip_address` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ref_dokumen_dosen` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kode unik tanpa spasi, cth: ktp, ijazah',
  `nama_dokumen` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama label dokumen untuk UI, cth: Scan Kartu Identitas (KTP)',
  `allowed_types` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pdf,jpg,jpeg,png' COMMENT 'Format file yang diizinkan dipisah koma',
...
CREATE TABLE `ref_ruang` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode_ruang` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ref_tahun_akademik` (
  ...
  `feeder_semester_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ID semester feeder',
...
CREATE TABLE `sinkronisasi_batches` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tahun_akademik_id` bigint unsigned NOT NULL,
  `mode` enum('DRY_RUN','EKSEKUSI') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'EKSEKUSI',
  `status` enum('PROCESSING','COMPLETED','FAILED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PROCESSING',
  `parameter_snapshot` json NOT NULL,
  `summary_snapshot` json DEFAULT NULL,
  `total_mahasiswa` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sinkronisasi_review_items` (
  ...
  `status` enum('PENDING','IN_PROGRESS','RESOLVED','IGNORED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  `keuangan_adjustment_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `resolved_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `resolved_at` timestamp NULL DEFAULT NULL,
  `catatan_resolusi` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (188,'2026_07_16_002854_create_kampus_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (189,'2026_07_16_002855_add_reset_nim_tahunan_to_kampus_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (190,'2026_07_16_002856_add_neo_feeder_to_kampus_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (191,'2026_07_16_002857_add_pro_settings_to_kampus_settings',1);
